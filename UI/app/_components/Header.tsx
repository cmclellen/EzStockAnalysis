    ...
    <div className="bg-primary-container text-on-primary-container">
      <div className="flex items-center justify-between container mx-auto p-2 relative">
        <div className="flex items-center space-x-1">
          ...
          <h1 className="font-font text-lg">
        ...
        <ul
          ref={ref}
          className={clsx(
            "sm:space-x-3 text-sm absolute sm:static top-12 left-0 sm:flex flex-col sm:flex-row font-semibold w-full sm:w-auto py-2 sm:py-0 sm:bg-transparent rounded-b shadow-lg sm:shadow-none bg-primary-container",
            {
              hidden: !showMenu,
            }
          )}
